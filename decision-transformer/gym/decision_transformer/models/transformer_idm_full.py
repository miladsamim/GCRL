...
class TransformerIDMFull(TrajectoryModel):
    ...
    def forward(self, states, actions, rewards, returns_to_go, timesteps, attention_mask=None, tgt_mask=None):
        ...
        ).permute(0, 2, 1, 3).reshape(batch_size, 3*seq_length, self.args.embed_dim)
        ...
        x = x.reshape(batch_size, seq_length, 3, self.args.embed_dim).permute(0, 2, 1, 3)
    ...
    def get_action(self, states, actions, rewards, returns_to_go, timesteps, **kwargs):
            ...
            tgt_mask = to_2d_mask_idm(attention_mask, 3, device=self.device, use_idm=False)
