...
class DiscreteTrajDEC_IDMPolicy_CLAW(nn.Module):
    def __init__(self, env, args):
        ...
        self.dim_out = self.n_dims * self.granularity
    ...
    def flattened(self, tensor):
        ...
        multipliers = self.granularity ** torch.tensor(np.arange(self.n_dims), device=self.device)
